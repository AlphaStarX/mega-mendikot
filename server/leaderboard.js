...
// tensCaptured }) and return ranked leaderboard rows. Sorts by wins desc, then
// matchesPlayed asc (a player who reached N wins in fewer games ranks higher — a
// light skill tiebreak), assigns a 1-based rank, and computes winRate (wins over
// decisive games: wins+losses; draws excluded, matching the profile screen).
// Drops any row under the min-matches floor. Never throws — defensive on inputs.
